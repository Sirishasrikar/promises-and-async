...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/databases.js":[function(require,module,exports) {
"use strict";
 ...
 */
function central(_x) {
  return _central.apply(this, arguments);
}
/**
 ...
 */
function _central() {
  _central = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var db;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          return wait(100);
        case 6:
          // Faking an "external" call here by adding a delay.
          db = "db1";
          if (id > 4) db = "db2";
          if (id > 7) db = "db3";
 ...
 */
function _db() {
  _db = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    var data, json;
...
function db2(_x3) {
  return _db2.apply(this, arguments);
}
/**
 * Accepts a user id value and returns an object containing
 * username, website, and company data.
 ...
 */
function _db2() {
  _db2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    var data, json;
...
function db3(_x4) {
  return _db3.apply(this, arguments);
}
/**
 * Accepts a user id value and returns an object containing
 ...
 */
function _db3() {
  _db3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    var data, json;
...
function _vault() {
  _vault = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(id) {
    var data, json;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // Importing database functions. DO NOT MODIFY THIS LINE.
...
function _getUserData() {
  _getUserData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var dbName, _yield$Promise$all, _yield$Promise$all2, basicInfo, personalInfo, userData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _databases.central)(id);
        case 3:
          dbName = _context.sent;
          _context.next = 6;
          return Promise.all([dbs[dbName](id), (0, _databases.vault)(id), _databases.db3]);
        case 6:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
          basicInfo = _yield$Promise$all2[0];
          personalInfo = _yield$Promise$all2[1];
        ...
        case 14:
          ...
          throw new Error("Database Error: ".concat(_context.t0.message));
        case 17:
        case "end":
          return _context.stop();
      }
...
// Example usage:
getUserData(11).then(function (userData) {
...
// getUserData("invalid")
// getUserData(true)
},{"./databases.js":"src/databases.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
